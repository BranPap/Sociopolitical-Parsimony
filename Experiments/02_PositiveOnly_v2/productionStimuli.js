...
function generateTrialObjects(exposedTopics = []) {
    ...
    const articleBylines = {
        ...
        "DnD": [
            `Dungeons & Dragons is experiencing a renaissance, with celebrity players and streaming shows bringing the tabletop RPG to mainstream audiences.`,
            `From basement hobby to Hollywood blockbuster, this fantasy role-playing game is capturing a new generation of players. Here's what you need to know.`
        ],
        "trumpBible": [
            `A new patriotic edition of the Bible featuring American flag imagery and founding documents has sparked debate about the intersection of faith and politics.`,
            `Some see it as a celebration of American values, while critics question the mixing of religious texts with political messaging. The controversy explained.`,
        ],
        "luigi": [
            `The suspect in the killing of UnitedHealthcare CEO Brian Thompson was apprehended after a multi-state manhunt.`,
            `From his background to the evidence against him, here's everything we know about the suspect in custody for the UnitedHealthcare CEO's death.`,
        ],
        "SillyBandz": [
            `Parents thought they'd seen the last of these colorful rubber bands in 2010, but the playground craze has returned with a vengeance.`,
            `From elementary schools to TikTok, the silicone bracelet trend that defined the early 2010s is making an unexpected comeback. Here's why kids can't get enough.`,
        ]
    };
