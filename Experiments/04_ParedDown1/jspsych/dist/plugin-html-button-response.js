var jsPsychHtmlButtonResponse = (function (jspsych) {
  ...
  const info = {
      ...
      parameters: {
          ...
          /** If true, will hide submit buttons until specified time */
          wait_before_showing_buttons: {
              type: jspsych.ParameterType.INT,
              pretty_name: "Wait before showing buttons",
              default: 0,
          },
      },
  };
   ...
   * modified by Bran Papineau Oct 2025 to add wait_before_showing_buttons parameter
   */
          ...
          for (var i = 0; i < trial.choices.length; i++) {
              ...
              html +=
                  '<div class="jspsych-html-button-response-button" style="display: inline-block; margin:' +
                      ...
                      '; visibility:hidden" id="jspsych-html-button-response-button-' +
                      i +
                      '" data-choice="' +
                      i +
                      '">' +
