...
function evaluate_response(data) {
    if (data.response == 'f' & data.wordhood == "word") {
        data.wordhoodCheck = "correctID"
    } else if (data.response == "f" & data.wordhood == "nonWord") {
        data.wordhoodCheck = "falseAlarm"
    } else if (data.response == "j" & data.wordhood == "nonWord") {
        data.wordhoodCheck = "correctRejection"
    } else if (data.response == "j" & data.wordhood == "word") {
        data.wordhoodCheck = "badRejection"
    } else {
...
//     if (data.response == 'f' & leftValue == data.wordhood) {
//         data.statusCheck = "correct"
//     } else if (data.response == 'j' & rightValue == data.wordhood) {
//         data.statusCheck = "correct"
//     } else {
