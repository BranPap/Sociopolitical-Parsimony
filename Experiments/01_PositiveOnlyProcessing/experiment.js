...
const lexicalDecisionInstructions2 = {
    ...
    stimulus: `<div style="max-width: 1000px; margin: 0 auto; text-align: left;">
        ...
        On each of the following screens, you will be shown a word. 
        If the word is a real word, please press <b>'f'</b>. This <b>includes new words learned in the articles from earlier</b>. 
        If the word is <em>not</em> a real word, please press <b>'j'.</b></p><p style = "text-align: center">When you are ready to begin, press 'j'</p></div>`,
    choices: ['j']
}
...
const lexicalDecision = {
        ...
        prompt: `
            ...
            <div class="newspaper-prompt">
                <div class="key-choice-container">
                    <div class="key-choice">
                        <p class="key-letter">f</p>
                        <p class="key-label">word</p>
                    </div>
                    <div class="key-choice">
                        <p class="key-letter">j</p>
                        <p class="key-label">non-word</p>
                    </div>
                </div>
            </div>
        `,
    ...
    randomize_order: true,
    on_start: function(data) {
        console.log(jsPsych.timelineVariable('stimWord'))
    },
    on_finish: function(data) {
        evaluate_response(data);

        console.log(data.response);
        console.log(data.wordhoodCheck);
